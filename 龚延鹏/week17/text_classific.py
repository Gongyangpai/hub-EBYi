...
# 模型1：机器学习模型
dataset = pd.read_csv(r"D:/BaiduNetdiskDownload/第1周：课程介绍与大模型基础/Week01/dataset.csv", sep="\t", header=None, nrows=10000)
# print("数据集各类别数量分布：")
...
client = OpenAI(
    ...
    # 替换为自己的api_key
    api_key="sk-9fd8006c309b44e7bd52dd1226222fe0", # 账号绑定，用来计费的
    # 大模型厂商的地址，阿里云，不用改动
...
def text_calssify_using_llm(text: str) -> str:
    ...
    completion = client.chat.completions.create(
        model="qwen3.7-max-2026-05-20",  # 模型的代号
        messages=[
